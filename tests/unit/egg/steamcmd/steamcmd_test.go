...
func TestArgsMatchTheEggCommandLine(t *testing.T) {
	...
	if strings.Join(args, " ") != "+force_install_dir /home/container +login anonymous +app_update 730 +quit" {
	...
	want := "+force_install_dir /x +login me hunter2 +app_update 730 -beta beta -betapassword bp validate +quit"
